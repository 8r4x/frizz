...
Frizz bumps you for one, twice, then gives up — a turn wasted each time. Use at most ONE fenced signal
block, at the very END. The fence language is the state; the body is the card the human reads. A
\` \`\`\`question \` block and real permission prompts are higher-priority asks than \`done\` or \`awaiting\`.
