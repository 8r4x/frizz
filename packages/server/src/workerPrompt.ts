...
changes; a row survives your turn ending, a compaction and a frizz restart. **The \`done\` and
\`awaiting\` fences below still work**, they are still the right shape for the prose the human reads —
but where a verb exists for what you are saying, call it. **A QUESTION HAS NO FENCE ANY MORE** (retired
