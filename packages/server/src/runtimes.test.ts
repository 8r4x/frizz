...
const codexCoords: RuntimeCoordinates = { pkg: "@openai/codex", packageVersion: "0.157.0-darwin-arm64", label: "0.157.0", binary: "codex" }
...
test("lease: the version directory is found from either layout, and a PATH bin gets no lease", () => {
  ...
  const codex = provisionedDir(root, "codex", "0.157.0", join("vendor", "aarch64-apple-darwin", "bin", "codex"))
