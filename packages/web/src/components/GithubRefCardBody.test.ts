...
test("recency reads in GitHub's coarse vocabulary, not in hours and minutes", () => {
  const now = Date.parse("2026-08-14T12:00:00Z")
  const ago = (iso: string) => coarseAgo(iso, now)
  assert.equal(ago("2026-08-14T11:59:30Z"), "just now")
  assert.equal(ago("2026-08-14T11:20:00Z"), "40 minutes ago")
  assert.equal(ago("2026-08-14T09:00:00Z"), "3 hours ago")
  assert.equal(ago("2026-08-13T09:00:00Z"), "1 day ago")
  assert.equal(ago("2026-07-31T10:55:44Z"), "2 weeks ago")
  assert.equal(ago("2026-05-14T12:00:00Z"), "3 months ago")
  // Past a year "N years ago" stops telling anyone anything, so the card gives the date instead.
