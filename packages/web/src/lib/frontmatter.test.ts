...
test("a leading frontmatter block is split off, line by line, and the body starts after it", () => {
  const md = "---\ntitle: Zod 4.5\n\ndate: 2026-08-25\n---\n# Post\n\nBody.\n"
  assert.deepEqual(splitFrontmatter(md), { front: ["title: Zod 4.5", "date: 2026-08-25"], body: "# Post\n\nBody.\n" })
})
