...
// `/login` and `/logout` are FRIZZ-OWNED aliases for the typed provider account actions — they are
...
// "/login please" or any other "/word" remains an ordinary prompt — frizz does not confiscate syntax
