...
//
// Usage: node scripts/seed-digest-edits.mjs <home> <socket> <projectDir>
import { execFileSync } from "node:child_process"
import fs from "node:fs"
import path from "node:path"

const [home, socket, projectDir] = process.argv.slice(2)
if (!home || !socket || !projectDir) throw new Error("usage: seed-digest-edits.mjs <home> <socket> <projectDir>")
