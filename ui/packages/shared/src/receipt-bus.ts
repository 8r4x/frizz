  ...
  return {
    ...
    waitFor(predicate, waitOptions = {}) {
      ...
      return new Promise<T>((resolve, reject) => {
        ...
        // shared/ is typechecked under BOTH the node and the DOM lib (the web project pulls it in), and
        // DOM's setTimeout returns a bare number — so reach for unref structurally rather than by type.
