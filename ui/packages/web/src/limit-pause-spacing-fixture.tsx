...
// transcript-card chrome (CardKind header, then the sentence, then a right-justified CardActions row),
    ...
    <main className="min-h-screen bg-bg p-8 text-fg">
      <div className="mx-auto max-w-[820px] space-y-8">
        <section className="space-y-3">
          <h2 className="text-[13px] font-semibold text-amber-300/90">Shared card chrome — header, sentence, right-justified action</h2>
