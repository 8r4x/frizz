...
//   npx tsx scripts/seed-rested-subagent.mjs --port=4931 --home=<stack home> --socket=<stack socket> [--tag=-b] [--project=/abs]
...
const PROJECT = opt("project", process.cwd().replace(/\/ui$/, ""))
