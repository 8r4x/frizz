...
//     in-project path. The bottom shimmer must read `Editing ui/packages/web/src/components/ChatView.tsx`
...
function write(slug, sessionId, title, records) {
  ...
  execFileSync("sqlite3", [
    ...
    `INSERT INTO session (slug, session_id, tmux_name, spawned_at, title, title_auto, backend, model, effort, permission_mode, state, unread, exited, archived)
     VALUES ('${slug}', '${sessionId}', 'fray-${slug}', '${T(0)}', '${title}', 0, 'claude', 'opus', 'high', 'auto', 'open', 0, 0, 0)`,
  ])
  ...
  { type: "user", timestamp: T(0), sessionId: "44444444-4444-4444-8444-444444444444", message: { role: "user", content: "Shorten the shimmer's file path." } },
  {
    ...
    message: {
      ...
      content: [call("toolu_settled", "Edit", {
        file_path: `${projectDir}/ui/packages/web/src/lib/toolActivity.ts`,
  ...
  },
  {
    ...
    message: {
      ...
      content: [call("toolu_live", "Edit", {
        file_path: `${projectDir}/ui/packages/web/src/components/ChatView.tsx`,
