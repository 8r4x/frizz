...
if (!existsSync(SHOT)) {
  const icon = join(cwd, "ui", "packages", "web", "public", "icon-512.png")
...
execFileSync("sqlite3", [db, `INSERT OR REPLACE INTO session
  ...
  VALUES ('${SLUG}', '${SESSION_ID}', '${tmuxName}', '${now}', 'Attachment render check', 'claude', 'opus', 'high', 'default', 0, 0, 0, 0, 0, 0);`])
