...
- **Snoozed** — the dimmed, labeled band under Active: a valid future `timer:`, a user wall-clock snooze, the resting card's event-snooze (parked until the thread next comes to rest — since 2026-08-28; before that it sat in Active with the dot), or a limit pause frizz will auto-resume. Parked, not asking. Renamed from **Held** on 2026-08-26, key and label together.
